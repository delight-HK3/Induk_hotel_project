<?
	class Reservation extends CI_Controller {               // 클래스이름 첫 글자는 대문자
		function __construct(){
			parent::__construct();
			$this->load->database();                     // 데이터베이스 연결
			$this->load->model("Reservation_m");    // 모델 a_member_m 연결
		...
		public function select(){
			...
			{  
				  $output = '';  
				  $connect = mysqli_connect("localhost", "team1", "1234", "team1");  
							...
							<div id="carouselExampleIndicators1" class="carousel slide" data-ride="carousel">
								...
								<div class="carousel-inner">
									<div class="carousel-item active">
									  <img src="/~team1/my/img/indukroom/'.$row["image_room1"].'" style="width:600px; height:300px;">
									</div>
									<div class="carousel-item">
									  <img src="/~team1/my/img/indukroom/'.$row["image_room2"].'" style="width:600px; height:300px;">
									</div>
									<div class="carousel-item">
									  <img src="/~team1/my/img/indukroom/'.$row["image_room3"].'" style="width:600px; height:300px;">
									</div>
								</div>
								...
								<div style="text-align:center">
								 ...
								 <div style="padding-left:50px">
									<ul>
										...
										<span style="font:bold; color:blue"><li style="font-family: Noto Sans KR, sans-serif;">만 12세(초등학교 6학년) 이하의 어린이는 라운지 입장이 제한됩니다.</li> </span>	
									</ul>
								</div><br><hr><br>
								<div style="text-align:center">
									<div class="single-footer-widget">
								...
								<div class="row">
									<div class="col-4">
										...
										<span style="color:black; text-align:center"><h5>일반</h5> </span>
											<p style="font-family: Noto Sans KR, sans-serif;">'.$row["normal"].'</p>
										<br>
										</div>
									</div>
									<div class="col-4">
										...
										<span style="color:black; text-align:center"><h5>욕실</h5> </span>
											<p style="font-family: Noto Sans KR, sans-serif;">'.$row["bathroom"].'</p>
										<br>
										</div>
									</div>
									<div class="col-4">
										...
										<span style="color:black; text-align:center"><h5>기타</h5> </span>
											<p style="font-family: Noto Sans KR, sans-serif;">'.$row["other"].'</p>
										<br>
										</div>
									</div>
								</div><br><hr>
				 ...
				 <div id="carouselExampleIndicators2" class="carousel slide" data-ride="carousel">
				  ...
				  {  
					   $output .= '  
						  ...
						  <div class="carousel-inner">
							<div class="carousel-item active">
							  <img src="/~team1/my/img/indukroom/'.$row["image_room1"].'" style="width:95%; height:95%; padding-top:20px">
							</div>
							<div class="carousel-item">
							  <img src="/~team1/my/img/indukroom/'.$row["image_room2"].'" style="width:95%; height:95%; padding-top:20px">
							</div>
							<div class="carousel-item">
							  <img src="/~team1/my/img/indukroom/'.$row["image_room3"].'" style="width:95%; height:95%; padding-top:20px">
							</div>
						  </div>
						  </center>
