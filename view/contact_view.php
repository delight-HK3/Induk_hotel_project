<!--===== Footer 고객문의 화면 =====-->
				...
				<div class="container">
					<div class="banner_content text-center"><br><br><br><br><br><br><br><br>
						...
						<div class="animated fadeInUp">
							<center><font class="animated fadeInUp" style="font-family: 'Noto Sans KR', sans-serif; font-size:40px; color:white;">고객의 소리</font>
							<br><br><br>
							<font class="animated fadeInUp" style="font-family: 'Noto Sans KR', sans-serif; font-size:20px; color:white">호텔 이용과 관련된 궁금한 사항이 있으시면 문의를 남겨주시기 바랍니다, 가능한 빠른 답변을 드리겠습니다.</font></center>
						</div>
					</div>
				</div>
			</div> 
	...
	<div class="container">  
	  ...
	  <form name="form1" method="post" action="/~team1/contact/add" enctype="multipart/form-data" onsubmit="return check()">
		<br><h2 class="title_color">문의내용</h2>
