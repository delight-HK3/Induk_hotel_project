                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-block outer">
                                <a href="/~team1/main"><img class="inner" src="/~team1/my/img/Hotel_name_admin_login.png" style="padding-left:30px"></a>
                            </div>
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="form_login" method="post" action="/~team1/admin/clientlogin">
                                    ...
                                    <hr>
                                    <button type="button" class="btn btn-primary btn-user btn-block" style="background:#cc9900; border:0px" onclick="submit();">
                                        Login
                                    </button>
                                    </form>
                                </div>
