					...
					<div class="col-lg-6">
						<div id="<?php echo($row->no)?>" class="carousel slide" data-interval = "false">
							...
							<div class="carousel-inner">
								<div class="carousel-item active">
									<img src="/my/img/service/<?php echo($row->image_serve1);?>" class="d-block w-100" height="350" alt="First slide">
								</div>
								<div class="carousel-item">
									<img src="/my/img/service/<?php echo($row->image_serve2);?>" class="d-block w-100" height="350" alt="Second slide">
								</div>
								<div class="carousel-item">
									<img src="/my/img/service/<?php echo($row->image_serve3);?>" class="d-block w-100" height="350" alt="Third slide">
								</div>
							</div>
						...
						<div class="col-lg-12" style="border:1px solid rgb(179, 131, 0); padding:15px; margin-bottom:60px">
							...
							<div style="overflow : hidden;">
								...
								<a href="/service/detail/no/<?php echo($row->no);?>" style="width:150px" class="btn theme_btn button_hover float-right">상세정보</a>
							</div>
						</div>
					</div>
				<?php
