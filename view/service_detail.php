<section class="banner_area">
	<div class="serveervation_table d_flex align-items-center">
        <div class="overlay" style="background: url('/~team1/my/img/service/<?php echo($service->image_serve1);?>') no-repeat scroll center 0/cover; opacity: 0.5; " data-stellar-ratio="0.9" data-stellar-vertical-offset="0" data-background=""></div>
		<div class="container">
                        ...
                        <div id="<?php echo($service->no);?>" class="carousel slide carousel-fade" data-interval = "false">
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="/~team1/my/img/service/<?php echo($service->image_serve1);?>" class="d-block w-100"  height="700" alt="1">
                                </div>
                                <div class="carousel-item">
                                    <img src="/~team1/my/img/service/<?php echo($service->image_serve2);?>" class="d-block w-100"  height="700" alt="2">
                                </div>
                                <div class="carousel-item">
                                    <img src="/~team1/my/img/service/<?php echo($service->image_serve3);?>" class="d-block w-100"  height="700" alt="3">
                                </div>
                                <div class="carousel-item">
                                    <img src="/~team1/my/img/service/<?php echo($service->image_serve4);?>" class="d-block w-100"  height="700" alt="3">
                                </div>
                                <div class="carousel-item">
                                    <img src="/~team1/my/img/service/<?php echo($service->image_serve5);?>" class="d-block w-100"  height="700" alt="3">
                                </div>								
                            </div>
			...
			<div class="row">
				...
				<div class="col-lg-7">
					<?php
						...
						{
					?>		
							<form action="/~team1/service/reple_delete/no/<?php echo($row->no)?>/service_no/<?php echo($service->no);?>" method="post" >
...
<div class="modal fade" id="repleModal" tabindex="-1" data-backdrop="static" role="dialog" aria-labelledby="exampleModelLabel" >
	<div class="modal-dialog" role="document" style="width:400px">
		<div class="modal-content" style="width:402px">
			...
			<form method="post" action="/~team1/service/reple/no/<?php echo($service->no)?>?>" onsubmit="return replecheck()">
